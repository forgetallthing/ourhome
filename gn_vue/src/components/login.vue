            ...
            <el-tab-pane label="密码登录" name="first">
                <el-form label-position="left"  label-width="40px" :model="form">
                    ...
                    <el-row>
                        ...
                        <el-col :span="9" >                      
                            <el-breadcrumb separator="/">
                                <el-breadcrumb-item ><span class='cursor' @click="to_forgetpass()">忘记密码</span></el-breadcrumb-item>
                                <el-breadcrumb-item><span class='cursor' @click="to_register()">注册</span></el-breadcrumb-item>
                            </el-breadcrumb>
                        </el-col>
                    </el-row>  
                    ...
                    <el-row type="flex" class="marginbottom_20" justify="space-around">
                        <el-col :span="4"><div class='weixin'></div></el-col>
                        <el-col :span="4"> <div class='weibo'></div></el-col>
                        <el-col :span="4"><div class='qq'></div></el-col>
                    </el-row>    
                </el-form>
            </el-tab-pane>
                ...
                <el-form label-position="left"  label-width="55px" :model="noteform">
                    ...
                    <el-form-item>
                        ...
                        <el-row>
                            ...
                            <el-col :span="9" >                      
                                <el-breadcrumb separator="/">
                                    <el-breadcrumb-item ><span class='cursor' @click="forgetpass()">忘记密码</span></el-breadcrumb-item>
                                    <el-breadcrumb-item><span class='cursor' @click="register()">注册</span></el-breadcrumb-item>
                                </el-breadcrumb>
                            </el-col>
                        </el-row> 
                        <el-row class='_textcenter font_14' style='margin-top:30px;margin-bottom:20px;color:gray;'>
                ...
                <el-form label-position="left" :rules="rules2" ref="regiform" status-icon  label-width="68px" :model="regiform">
                    ...
                    <el-row class="marginbottom_20" >
                        <el-col :span="11" :offset='13' >                      
                            <el-breadcrumb separator="/">
                                <el-breadcrumb-item ><span class='cursor' @click="to_login()">已有账号，返回登录</span></el-breadcrumb-item>
                            </el-breadcrumb>
                        </el-col>
                    </el-row>  
                </el-form>
                ...
                <el-form label-position="left" label-width="55px" :model="getpass">
                    ...
                    <el-row class="marginbottom_20" >
                        <el-col :span="6" :offset='18' >                      
                            <el-breadcrumb separator="/">
                                <el-breadcrumb-item ><span class='cursor' @click="to_login()">返回登录</span></el-breadcrumb-item>
                            </el-breadcrumb>
                        </el-col>
                    </el-row>  
                </el-form>
